...
function InserirFilmesNaTela(filmes) {
  ...
  filmes.forEach(movie => {
    ...
    parte1.className = 'cards_parte1';

    const img = document.createElement('img');
    img.src = posterPath;
    img.alt = 'Capa';
    img.className = 'cards_parte1-capa';

    parte1.appendChild(img);
    section.appendChild(parte1);

    const parte2 = document.createElement('div');
    parte2.className = 'cards_parte2';

    const titulo = document.createElement('h2');
    titulo.className = 'cards_parte2-titulo';
    titulo.textContent = `${title} (${releaseYear})`;

    const details = document.createElement('div');
    details.className = 'cards_parte2-details';

    const ratingDiv = document.createElement('div');
    const ratingImg = document.createElement('img');
    ratingImg.src = 'img/Star.svg';
    ratingImg.alt = 'star';
    ratingImg.className = 'cards_parte2-icon';
    const ratingText = document.createElement('h2');
    ratingText.className = 'cards_parte2-text';
    ...
    favoriteCheckbox.className = 'cards_parte2-checkbox';
    ...
    favoriteText.className = 'cards_parte2-text';
    ...
    parte3.className = 'cards_parte3';

    const texto = document.createElement('p');
    texto.className = 'cards_parte3-texto';
